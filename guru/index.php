...
<body>
    ...
    <div id="appShell" class="app-shell" style="display:none;">
        ...
        <nav class="bottom-nav">
            ...
            <button class="bottom-nav-item" data-page="jadwal" onclick="location.hash='#/jadwal'">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            ...
            <button class="bottom-nav-item" data-page="jurnal" onclick="location.hash='#/jurnal'">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            ...
            <button class="bottom-nav-item" data-page="riwayat" onclick="location.hash='#/riwayat'">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
