...
-- =============================================
-- ROLE & ACCESS CONTROL (AKSES MODUL)
-- =============================================

-- Role Akses Pengguna E-Examination
...
-- =============================================
-- MONITORING & SESSION LOCK SISWA
-- =============================================

-- Status Login & Kunci Siswa saat Ujian
CREATE TABLE IF NOT EXISTS `exam_student_login` (
  ...
  `is_locked` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '1 = Terkunci karena keluar aplikasi saat mengerjakan',
