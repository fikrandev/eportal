...
if (!$user) {
    echo '<!DOCTYPE html><html><head><meta charset="UTF-8"><title>Akses Ditolak</title>    <?php echo get_module_theme_css('e-curriculum'); ?>
...
<head>
    ...
    <?php echo get_module_theme_css('e-curriculum'); ?>
</head>
<body>
    <!-- Global Loading -->
